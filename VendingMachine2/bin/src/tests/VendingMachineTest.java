 ...
 *
 * @generatedBy CodePro at 3/5/18, 12:27 PM
 * @author Kolbe
...
public class VendingMachineTest {
	 ...
	 */
	@Test
	public void testAddItem_custom_1()
		throws Exception {
		VendingMachine fixture = new VendingMachine();
		fixture.setBalance(1.0);
		VendingMachineItem item = new VendingMachineItem("", 1.0);
	 ...
	 */
	@Test
	public void testAddItem_custom_2()
		throws Exception {
		VendingMachine fixture = new VendingMachine();
		fixture.setBalance(1.0);
		VendingMachineItem item = new VendingMachineItem("", 1.0);
	 ...
	 */
	@Test
	public void testAddItem_custom_3()
		throws Exception {
		VendingMachine fixture = new VendingMachine();
		fixture.setBalance(1.0);
		VendingMachineItem item = new VendingMachineItem("", 1.0);
	 ...
	 */
	@Test(expected = edu.towson.cis.cosc442.project3.vendingmachine.VendingMachineException.class)
	public void testAddItem_custom_4()
		throws Exception {
		VendingMachine fixture = new VendingMachine();
		fixture.setBalance(1.0);
		VendingMachineItem item = new VendingMachineItem("", 1.0);
	 ...
	 */
	@Test
	public void testMakePurchase_custom()
		throws Exception {
		VendingMachine fixture = new VendingMachine();
		VendingMachineItem item = new VendingMachineItem("", 1.0);
		String code = "A";
		...
		assertEquals(true, fixture.makePurchase("A"));
	}
